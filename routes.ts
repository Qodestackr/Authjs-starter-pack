//so by default all the routes are private and only accessible to authenticated users you
// have to specify the routes that are public and can be accessed by all users
...
// this is the prefix for all the routes that are related to the authentication and this is always public routes
